...
<head>
  ...
  <!-- Theme css -->
  <link rel="stylesheet" type="text/css" href="{{url('assets/css/color2.css')}}" media="screen" id="color">
</head>
<body class="bg-light">
                  ...
                  <div class="hotdeal-right-slick border-0">
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="../assets/images/layout-2/hot-deal/8.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="../assets/images/layout-2/hot-deal/7.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="../assets/images/layout-2/hot-deal/6.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                    <a href="product-page(left-sidebar).html">
                      <div class="img-wrraper">
                        <div>
                          <img src="../assets/images/layout-2/hot-deal/5.jpg" alt="hot-deal" class="img-fluid  bg-img">
                        </div>
                      </div>
                    </a>
                  </div>
...
<script src="{{url('assets/js/tippy-popper.min.js')}}"></script>
<script src="{{url('assets/js/tippy-bundle.iife.min.js')}}"></script>
